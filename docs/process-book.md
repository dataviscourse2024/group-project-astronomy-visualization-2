...
### Dashboard 2 Visulaisation

I started with the idea of dividing dashboard 2 into 4 div containters, where each container will display the graphical plots for our dataset. The goal is to allow for a visual representation of trends, patterns, and relationships within data for intended auidence. 
I started with scatterplot of distance from Sun vs Radius of planets and hover to capability providing descripton. However these are only 9 data points so after group meeting we decided to change this.
This is how the version 1 looks:
![alt text](dashboard2scatterplotversion1.png)

The updated outlook is : ![alt text](Dashboard2updated.png)

The finalsied plots based on the available dataset include following, with interactable feature to choose axes:  
scroll down option to display some information 
